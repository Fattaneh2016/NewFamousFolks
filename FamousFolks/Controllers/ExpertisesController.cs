...
namespace FamousFolks.Controllers
{
    public class ExpertisesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ExpId,Expertise1")] Expertise expertise)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ExpId,Expertise1")] Expertise expertise)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            Expertise expertise = db.Expertises.Find(id);
            if (expertise != null) db.Expertises.Remove(expertise);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
